<h1 align="center">AI6 - SMART VOICE ASSISTANT</h1>
...
<strong>You can also use the app to control media, or also as a remote keyboard.!</strong>
...
If you wish to build from the source, do "pip install -r requirements.txt" and run the "zpyDeploy.bat". You need to copy "model" folder in the root directory of the project.
You can find the "model" folder in the "AI.zip" in the download section.
